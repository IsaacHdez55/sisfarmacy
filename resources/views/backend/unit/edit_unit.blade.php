	...
	<div class="content container-fluid">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="card">
					<div class="card-body">
						<form action="{{ route('unit.update', $editData->id) }}" method="post">
...
<div class="form-group">
	...
	<div class="">
		<input type="text" name="units_name" class="form-control" value="{{ $editData->units_name }}" placeholder="Name Unit" required>
	</div>
</div>
								</div>{{-- End col-md-6 --}}
...
<div class="form-group">
	...
	<div class="">
		<input type="text" name="units_short_name" class="form-control" value="{{ $editData->units_short_name }}" placeholder="Short Name Unit">
	</div>
</div>
								</div>{{-- End col-md-6 --}}
